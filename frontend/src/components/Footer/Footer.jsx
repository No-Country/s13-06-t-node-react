...
const Footer = () => {
  return (
    <div className='md:bg-[#84BCDA] bg-[#A5CCE0] cursor-default mt-8 md:mt-0 md:pt-10 text-black'>
      <div className='flex flex-col md:flex-row justify-between md:pb-8 pb-4 md:px-14'>
        ...
        <div className='w-full md:w-1/4 flex md:flex-col md:items-start items-center justify-around md:bg-[#84BCDA] bg-white py-8'>
        ...
        <div className='px-8 '>
          ...
          <nav className='md:flex hidden flex-col gap-2'>
            <a
              className='hover:text-[#E9F9F1] transition-all cursor-pointer'
              href='/'
            >
              Quienes somos
            </a>
      ...
      <div className='flex gap-2 md:gap-0 justify-end items-end md:items-center md:justify-between md:py-4 md:px-14 px-3 flex-col-reverse md:flex-row px-8 pb-24'>
        <span className='text-sm font-semibold'>
          @2024 Todos los derechos reservados
        </span>
        <div className='flex flex-col md:flex-row items-center justify-end md:gap-4 gap-2'>
          <span className='text-sm font-semibold hover:text-[#E9F9F1] transition-all cursor-pointer'>
      ...
      <div className='h-20 md:hidden bg-[#84BCDA] flex items-end justify-center fixed bottom-0 left-0 right-0'>
